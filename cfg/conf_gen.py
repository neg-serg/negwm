...
class ConfGen(Enum):
    ...
    colors = {
        'background': ['#800000ee'],
        'focused': ['#800011dd', '#800000ee', '#80ddddee', '#80112211', '#800C0C0D'],
        'focused_inactive': ['#800000dd', '#800000ee', '#80005fff', '#80000000', '#80020204'],
        'placeholder': ['#800000ee', '#000000', '#ffffff', '#000000', '#0c0c0c'],
        'unfocused': ['#800000ee', '#000000', '#315c70', '#000000', '#020204'],
        'urgent': ['#800000ee', '#2E2457', '#4C407C', '#32275E', '#32275E']
    }
