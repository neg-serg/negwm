...
class conf_gen(extension, cfg):
    ...
    def generate_config(self) -> str:
        self.conf_data=[]
        self.conf_data.append('# [Generated by negwm]\n')
        for cfg_section in self.cfg.keys():
            if cfg_section.startswith('mode_'):
                self.conf_data.append(self.bind(cfg_section))
            if hasattr(self, cfg_section):
                cfg_section_handler = getattr(self, cfg_section)
                self.conf_data.append(cfg_section_handler())
        self.conf_data.append(self.mods_commands())
        self.conf_data.append('# vim:filetype=i3config\n')
    ...
    def plain(self) -> str: return conf_gen.text_section(self.cfg.get('plain'))
